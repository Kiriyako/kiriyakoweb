...
export default function About(){
  return (
   ...
   <Link href={`https://open.spotify.com/user/e4o9n8roznot3q36966roaa7j`}><h1>Spotify: Kiriyako</h1></Link>
   <Link href={`https://twitter.com/kiriyako3`}><h1>Twitter: @kiriyako3</h1></Link>
